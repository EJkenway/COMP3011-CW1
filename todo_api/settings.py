...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-nl&$yygdfo@r24r-nha!943@j4^lmjr^s9ku&@d%ibs4j($^34')
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Smart Productivity Analytics Platform API',
    'DESCRIPTION': '''
## Overview
...
This API is designed to be Model Context Protocol (MCP) compatible for AI agent integration.
    ''',
    'VERSION': '1.0.0',
    ...
    'CONTACT': {
        'name': 'API Support',
        'email': 'support@productivity-api.example.com',
    },
    'LICENSE': {
        'name': 'MIT License',
    },
...
# =============================================================================
# External API Configuration (for weather integration, etc.)
# =============================================================================

EXTERNAL_APIS = {
    'WEATHER': {
        'ENABLED': os.environ.get('WEATHER_API_ENABLED', 'False').lower() == 'true',
